  ...
  return knex('items').del()
    .then(function () {
      return Promise.all([
        ...
        knex('items').insert({content: 'eat potatoes', users_id: 1, categories_id: 3}),
        knex('items').insert({content: 'eat at Oakwood Bistro', users_id: 1, categories_id: 3}),
        knex('items').insert({content: 'buy Rolex', users_id: 1, categories_id: 4}),
        knex('items').insert({content: 'buy Fidget spinner', users_id: 2, categories_id: 4}),
      ]);
    });
};
